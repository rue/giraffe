...
describe "Wiki page list at toplevel using /l/" do
...
describe "Wiki page list from subdirectory using /l/sub/dir/path" do
  ...
  it "does not contain pages from higher up in the hierarchy" do
    entries = Nokogiri::HTML.parse(get("/l/subdir").body).css ".entry > .page"
  ...
  it "does not contain names of nontracked pages" do
    links = Nokogiri::HTML.parse(get("/l/subdir").body).css "a"
